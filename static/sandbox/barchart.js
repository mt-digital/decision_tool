...
svg_1cnty.selectAll("line")
         ...
         .attr({
             ...
             "stroke-width": function(d) { 
               if (d == 0) { return 3; } else { return 1; } 
             }
         });

var question = onecounty_data.question;
...
svg_1cnty.selectAll("rect")
         ...
         .attr({
             ...
             "y": function(d,i) { return BAR_YPAD + calculateYValue(i, 1, 5); },
             "x": 1.5,
             "fill": function(d, i) {
                if (i % 1 == 0) {
                    return "blue";
